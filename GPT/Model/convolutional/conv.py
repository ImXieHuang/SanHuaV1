...
if __name__ == "__main__":
    ...
    print(f"最大池化: {pool(test_data, pool_size=2, stride=2, pool_type='max')}")
    print(f"平均池化: {pool(test_data, pool_size=2, stride=2, pool_type='avg')}")
    print(f"最小池化: {pool(test_data, pool_size=2, stride=2, pool_type='min')}")